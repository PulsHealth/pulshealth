...
There's no universal "good" HRV. Values vary dramatically by age, fitness, and genetics — and, just as much, by how long the recording is. Apple Watch takes short samples of about a minute; the numbers in medical literature usually come from overnight or 24-hour recordings, which are always higher. The two tables below are on different scales and must not be compared with each other.
